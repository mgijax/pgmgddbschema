...
/* clustered indexes that are USING the primary key */
...
/* clustered indexes that are not USING the primary key */
...
CLUSTER all_knockout_idx_clustered USING mgd.ALL_Knockout_Cache;
