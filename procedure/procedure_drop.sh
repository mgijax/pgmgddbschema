...
DROP FUNCTION MGI_insertSynonym(int,int,int,text,int);
DROP FUNCTION MGI_resetAgeMinMax(varchar,int);
DROP FUNCTION MGI_resetSequenceNum(varchar,int);
DROP FUNCTION MRK_alleleWithdrawal(int,int,int,int,int);
...
DROP FUNCTION MRK_splitWithdrawal(int,int,int,text);
